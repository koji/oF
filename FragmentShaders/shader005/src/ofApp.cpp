...
void ofApp::setup(){
    ...
    gui.setup();
    gui.add(u_slider1.setup("u_slider1", 0.05, 0., 1.0));
    gui.add(u_slider2.setup("u_slider2", 0.05, 0., 1.0));
    gui.add(u_slider3.setup("u_slider3", 0.05, 0., 1.0));
    gui.add(u_slider4.setup("u_slider4", 0.5, 0.01, 10.0));
